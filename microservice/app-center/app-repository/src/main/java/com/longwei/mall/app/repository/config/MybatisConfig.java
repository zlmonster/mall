package com.longwei.mall.app.repository.config;
...
public class MybatisConfig {
    public static final String MODEL_PACKAGE="com.longwei.mall.app.repository.entity";
    public static final String MAPER_PACKAGE="com.longwei.mall.app.repository.mapper";
    public static final String MAPPER_LOCATION_PATTERN="classpath*:com/longwei/mall/app/repository/mapper/**/*.xml";
