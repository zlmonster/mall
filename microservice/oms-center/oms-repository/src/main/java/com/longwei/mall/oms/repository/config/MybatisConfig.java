package com.longwei.mall.oms.repository.config;
...
public class MybatisConfig {
    public static final String MODEL_PACKAGE="com.longwei.mall.oms.repository.entity";
    public static final String MAPER_PACKAGE="com.longwei.mall.oms.repository.mapper";
    public static final String MAPPER_LOCATION_PATTERN="classpath*:com/longwei/mall/oms/repository/mapper/**/*.xml";
