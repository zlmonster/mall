...
public class GenericResponseBodyMethodProcessor extends RequestResponseBodyMethodProcessor {
	private static final Logger LOG = LoggerFactory.getLogger(GenericResponseBodyMethodProcessor.class);
	...
	public void handleReturnValue(Object returnValue,
		...
		LOG.info("begin handleReturnValue");
		/**包装方法返回的bean*/
		...
		LOG.info("end handleReturnValue");
