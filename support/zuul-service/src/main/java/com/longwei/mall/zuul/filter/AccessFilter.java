...
import com.longwei.mall.common.web.constants.GlobalProfile;
import com.longwei.mall.zuul.constants.FilterType;
import com.longwei.mall.zuul.constants.ForbiddenUri;
...
public class AccessFilter extends ZuulFilter {
    ...
    public Object run() {
        ...
        if(GlobalProfile.PROD.equals(profile)){
            String uri = request.getRequestURI();
            if(ForbiddenUri.filter(uri)){
